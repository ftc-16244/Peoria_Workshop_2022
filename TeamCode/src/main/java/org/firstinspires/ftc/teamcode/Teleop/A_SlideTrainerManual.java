...
/**
 * This is a very basic opmode to demonstrate manual control of a goBilda Viper Slide that has a servo,
 * an extra "intake" motor , an LED indicator and a servo to simulate a gripper.
 * The controls are all on one gamepad and the control is very challengine by design, The point
 * is to show an urgency to get rif of confusing and awkeard controls with some automation
 */
