...
public class Felipe_REV_Encoder {
    ...
    public Encoder      armExtEncoder   =  null;
    ...
    public int revReset = 0;
    public  int newposition;
    public int currentPosition;
    public int revOffset;

    public Felipe_REV_Encoder(LinearOpMode opmode) {
        this.opmode = opmode;
    }
    ...
    public void init(HardwareMap hwMap)  {
        ...
        julioArm.setMode(DcMotorEx.RunMode.RUN_WITHOUT_ENCODER);
       ...
       //julioArm.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
        armExtEncoder = new Encoder(hwMap.get(DcMotorEx.class, "julioArm"));
        //armExtEncoder = hwMap.get(DcMotorEx.class, "julioArm");
        //armExtEncoder.setDirection(DcMotorEx.Direction.REVERSE);
        //armExtEncoder.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        //armExtEncoder.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
       ...
       //julioArm.setTargetPositionTolerance(newtolerance); // mkaes juio arm more precise
        ...
        //julioArmExtEncoder.setDirection(Encoder.Direction.FORWARD);
    ...
    public double getJulioPosition(){
        ...
        julioPositionLocal =  armExtEncoder.getCurrentPosition()/TICKS_PER_DEGREE; //returns in degreesb
        return  julioPositionLocal;
    }


    //Julio the arm's methods
    public int getJulioPositionTicks(){
        double julioPositionLocalTicks;
        julioPositionLocalTicks =  armExtEncoder.getCurrentPosition(); //returns in degreesb
        return  (int)julioPositionLocalTicks;
    }

    //public  int newposition;
    //public int currentPosition;
    public void resetRevEncoder(){
       // revReset = (getJulioPosition() -(getJulioPosition();
        revOffset = getJulioPositionTicks();
    }

    public void rotate10000ticks(){
        resetRevEncoder();
        julioArm.setPower(.5);
        while ((getJulioPositionTicks() - revOffset) > newposition){
