...
public class BlueCarouselMeet3 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory  traj_HG_02 = drive.trajectoryBuilder(traj_HG_01.end())
                .lineToLinearHeading(new Pose2d(42,-33,Math.toRadians(179)))
        ...
        Trajectory  traj_MG_02 = drive.trajectoryBuilder(traj_MG_01.end())
                .lineToLinearHeading(new Pose2d(42,2,Math.toRadians(179)))
